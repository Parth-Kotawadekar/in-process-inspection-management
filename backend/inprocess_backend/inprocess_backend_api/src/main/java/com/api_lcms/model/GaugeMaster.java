...
@Entity
@Table(name = "gaugemaster_tb")
public class GaugeMaster {
    ...
    private CombinedMaster_1 repMaster;

    @ManyToOne
    @JoinColumn(name = "check_id")
    private Combined_Master_2 chechMaster;
    ...
    public CombinedMaster_1 getRepMaster() {
		return repMaster;
	}

	public void setRepMaster(CombinedMaster_1 repMaster) {
		this.repMaster = repMaster;
	}

	public Combined_Master_2 getChechMaster() {
		return chechMaster;
	}

	public void setChechMaster(Combined_Master_2 chechMaster) {
		this.chechMaster = chechMaster;
	}
    ...
    public GaugeMaster(Integer gauge_id, String gauge_name, String gauge_sr_no, String gauge_type,
                       ...
                       String nogo_tolerance_pus, String nogo_tolerance_minus, Employee employee, Customer customer) {
        this.gauge_id = gauge_id;
        this.gauge_name = gauge_name;
        this.gauge_sr_no = gauge_sr_no;
        this.gauge_type = gauge_type;
